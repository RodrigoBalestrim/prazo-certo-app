...
historia.append(B("Dados: PostgreSQL (Supabase), Row Level Security, Edge Functions (Deno), APIs REST"))
...
historia.append(B("Banco de dados relacional PostgreSQL com autentica\u00e7\u00e3o, controle de permiss\u00f5es por papel (5 n\u00edveis) e Row Level Security"))
